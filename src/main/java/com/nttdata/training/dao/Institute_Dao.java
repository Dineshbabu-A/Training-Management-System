...
public class Institute_Dao {
	...
	//delete
		public static int delete_institute( String Institute_Id) throws DBFWException{
	...
	//Update Institute
		...
		public static int register_institute(String string, String string2, String string3, String string4, int i,
				int j, String string5) {
			// TODO Auto-generated method stub
			return 0;
		}
